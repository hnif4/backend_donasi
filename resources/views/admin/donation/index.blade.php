        ...
        <form action="{{ route('admin.donation.firter') }}" method="GET">
            <div class="flex gap-6">
                <div class="flex-auto">
                    ...
                    <input class="form-input w-full mt-2 rounded-md bgwhite p-3 shadow-md" type="date" name="date_from" value="{{ old('date_form') ??
...
$message }}</p>
                ...
                <div class="flex-auto">
                    <label class="text-gray-700" for="name">TANGGAL
                        AKHIR</label>
                    <input class="form-input w-full mt-2 rounded-md bg￾white p-3 shadow-md" type="date" name="date_to" value="{{ old('date_to') ??
...
rounded-md shadow-md hover:bg-gray-700 focus:outline-none focus:bg￾gray-700">FILTER</button>
                </div>
            </div>
        </form>
        @if($donations ?? '')
