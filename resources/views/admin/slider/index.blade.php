...
text-gray-200 rounded-md hover:bg-gray-700 focus:outline-none focus:bggray-700">UPLOAD</button>
                </div>
            </form>
        </div>
                    ...
                    <tbody class="bg-gray-200">
                        ...
                        <tr class="border bg-white">
                            ...
                            <td class="px-10 py-2 text-center">
                                <button onClick="destroy(this.id)" id="{{ $slider->id }}" class="bg-red-600 px-4 py-2 rounded shadow-sm
